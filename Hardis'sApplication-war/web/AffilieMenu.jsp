...
<head>
    ...
    <![endif]-->
        ...
        <jsp:useBean id="sessionpersonnePhysique" scope="session" class="PersonnePhysique"></jsp:useBean>
                    ...
                    <div class="col-lg-8 d-none d-xl-block">
                        <nav class="mainmenu alignright">
                            <ul>
                                ...
                                <li class="active"><a onclick="location.href='Page?action=AffilieConnexion'"> Mes actions</a>
                                    <ul>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="section-title  text-center">
                        ...
                        <p>Bienvenue <span style="color: #ffd000; font-weight: bold"><%out.println(sessionpersonnePhysique.getPrenom()+" "+sessionpersonnePhysique.getNom());%></span> sur votre espace personnel</p>
                    </div>
                </div>
                <!-- Page Title End -->
            </div>
