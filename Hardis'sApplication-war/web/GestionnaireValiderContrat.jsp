...
<html>
    <head>
        ...
        <%
            ...
            Produit p;
        %>
        <%session.setAttribute("titre", "Valider Contrats");%>
        <%@ include file="Style.jsp"%>
        
    <body>
        <%@ include file="Header.jsp"%>
        <%session.setAttribute("t1", "Liste des contrats");%>
        <%session.setAttribute("t2", "Choisisez un contrat à valider");%>
                        ...
                        <div class="row" id="b" style="margin-left: 14%;">
                            <form name="formcherche" method="post" action="Page">
                                <div class="row">
                                    ...
                                    <div class="col-6">    
                                        <input type="hidden" name="action" value="GestionnaireValiderContrat"/>
                                        <button class="info-xin" type="submit" style="width:100%;" value="Valider">Rechercher</button>
                                    </div>
                                    <div class="col-6">   
                                        <input class="info-xin" type="button" style="width:100%;" value="Supprimer le filtre" onclick="location.href='Page?action=GestionnaireValiderContrat&ReSS='">
                                    </div>
                                </div>
                            </form>
                        </div>
                ...
                <div class="popup_box_xin ">
                    <div class="popup_inner">
                        <div class="section-top-border">
                            ...
                            <h3>
                                <input class="info-xin" type="submit" value="Valider"/>
                            </h3>
